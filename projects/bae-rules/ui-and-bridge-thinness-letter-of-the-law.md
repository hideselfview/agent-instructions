---
digest: bae-bridge is only type translation; UI iterates/renders; no derived values, formatting, or domain decisions in Swift.
paths:
  - '**/*.swift'
  - bae-bridge/**/*.rs
blocking: false
...
because cross-platform UI is the goal: macOS today, iOS / Android / web ahead.
Anything in the UI is something we'd rewrite per platform.
